# Contributing to Paranoid Linux
[heading__title]:
  #contributing-to-paranoid-linux
...
The text within this document are not _set in stone_ rules but guidelines, and much like other files maintained by Paranoid Linux the following may be edited via a _`Pull Request`_.
...
Join the <sub>[![Contributors][badge__contributors]][branch__current__network_members]</sub> issuing Pull Requests that close available <sub>[![Open Issues][badge__issues]][branch__current__issues]</sub>. [New Issues][branch__current__issues_new] may be opened for Reporting Bugs and Suggesting Enhancements. However, please search for existing similar Issues first; example search for [`memory-leaks`](https://github.com/paranoid-linux/.github/search?q=memory-leaks&type=Issues) from the `.github` repository.
...
set _organization='paranoid-linux'
...
There may be _`orphan`_ branches utilized by paranoid-linux for separating Code to be included in other projects from Documentation and Usage Examples. Non-orphaned development branches are encouraged when adding features or fixing bugs.
...
[branch__current__network_members]:
  network/members
  "Perhaps you too may be counted amount those that have Forked repositories maintain by Paranoid Linux"

[branch__current__support]:
  SUPPORT.md
  "Best avenues for seeking support of Paranoid Linux"
...
[badge__issues]: https://img.shields.io/github/issues/paranoid-linux/.github.svg

[badge__contributors]: https://img.shields.io/github/forks/paranoid-linux/.github.svg?color=005571&label=Contributors
